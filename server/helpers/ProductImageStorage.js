...
var ProductImageStorage = function (options) {

    // this serves as a constructor
    // this serves as a constructor
    function ProductImageStorage(opts) {
    ...
    ProductImageStorage.prototype._generateRandomFilename = function () {// create pseudo random bytes
    ...
    ProductImageStorage.prototype._createOutputStream = function (filepath, cb) {
    ...
    ProductImageStorage.prototype._processImage = function (image, cb) {
    ...
    ProductImageStorage.prototype._handleFile = function (req, file, cb) {
    ...
    ProductImageStorage.prototype._removeFile = function (req, file, cb) {
